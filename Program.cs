...
", GetSettings("TABLE_SCHEMA"), tableName);
        ...
        private static bool GeneratedTableModel(List<ColumnInfoModel> listColumn, TableInfoModel table)
        {
            ...
            foreach (var col in listColumn)
            {
                ...
                list.Add("        /// " + col.COLUMN_COMMENT);
                list.Add("        /// </summary>");
                list.Add("        public " + SqlDataTypeToCSharp.handle(col.DATA_TYPE) + (col.IS_NULLABLE == "YES" && SqlDataTypeToCSharp.handle(col.DATA_TYPE) != "string" ? "?" : "") + " " + turnHungary2CamelCase.StartChange(col.COLUMN_NAME) + " { get; set; }");
                list.Add("        ");
            }
        ...
        private static bool GeneratedServicesImpl(List<ColumnInfoModel> listColumn, string tableName)
        {
            ...
            list.Add("    {");
            list.Add("        private readonly I" + fileName + "Dao _" + fileName1 + "Dao;");
            list.Add("");
            list.Add("        //构造函数注入");
            ...
            list.Add("                if (entity == null)");
            list.Add("                {");
            list.Add("                    return new " + fileName2 + "();");
            list.Add("                }");
            ...
            list.Add("                if (pagerEntity == null)");
            list.Add("                {");
            list.Add("                    return new Pager<" + fileName2 + ">(0, 0, 0, listModel);");
            list.Add("                }");
        ...
        private static bool GeneratedDaoImpl(List<ColumnInfoModel> listColumn, string tableName)
        {
            ...
            list.Add("            }");
            list.Add("            catch (Exception ex)");
            list.Add("            {");
            list.Add("                Context." + tableNameNew + "s.Remove(entity);");
            ...
            list.Add("        {");
            list.Add("            var ent = Context." + tableNameNew + "s.Single(a => " + string.Join(" && ", listPK.Select(a => "a." + a.COLUMN_NAME1 + " == " + turnHungary2CamelCase.StartChange(a.COLUMN_NAME))) + ");");
            list.Add("            try");
            list.Add("            {");
            ...
            list.Add("            catch (Exception ex)");
            list.Add("            {");
            list.Add("                Context." + tableNameNew + "s.Add(ent);");
            list.Add("                return false;");
            list.Add("            }");
            list.Add("        }");
            list.Add("");
            ...
            list.Add("        {");
            list.Add("            return Context." + tableNameNew + "s.Where(a => " + string.Join(" && ", listPK.Select(a => "a." + a.COLUMN_NAME1 + " == " + a.COLUMN_NAME1)) + ").Any();");
            list.Add("        }");
            list.Add("");
            ...
            list.Add("        {");
            list.Add("            return Context." + tableNameNew + "s.AsNoTracking().Where(a => " + string.Join(" && ", listPK.Select(a => "a." + a.COLUMN_NAME1 + " == " + a.COLUMN_NAME1)) + ").FirstOrDefault();");
            list.Add("        }");
            list.Add("");
            list.Add("        public Pager<" + tableNameNew + "> GetPager(BaseCondition condition)");
            list.Add("        {");
            list.Add("            var tmpList = Context."+ tableNameNew + ".AsNoTracking();");
            list.Add("            var total = tmpList.Count();");
            ...
            list.Add("            }");
            list.Add("");
            list.Add("            return Update(entity);");
            list.Add("        }");
            list.Add("");
            list.Add("        public bool Update(" + tableNameNew + " entity)");
            list.Add("        {");
            list.Add("            var entityEntry = Context." + tableNameNew + "s.Update(entity);");
            list.Add("            try");
            list.Add("            {");
            list.Add("                return Context.SaveChanges() > 0;");
            list.Add("            }");
            list.Add("            catch (Exception ex)");
            list.Add("            {");
            list.Add("                entityEntry.State = EntityState.Detached;");
            list.Add("                return false;");
            list.Add("            }");
            list.Add("        }");
            list.Add("");
